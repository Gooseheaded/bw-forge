-- Disposable Milestone 1 prototype. Not a production migration.
...
CREATE TABLE corpus_metadata (
 ...
 name_normalizer TEXT NOT NULL, purpose TEXT NOT NULL CHECK(purpose='disposable-milestone-1')
) STRICT;
...
CREATE TABLE stream_coverage (
 ...
 stream TEXT NOT NULL CHECK(stream IN ('economy','composition')),
