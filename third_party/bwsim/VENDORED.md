...
- Upstream version/tag: `v0.1.4`
- Upstream commit: `d8a1015464afbab9fc1d3d7426fc7e8952ce5e85`
...
generation-bearing `bw_unit_instance_id(index) -> i32` export. Release v0.1.4
...
API. It retains the classified replay UnitId namespace and provides checked
native-to-replay ID conversion for compatibility serialization. The original
Wasm is retained for provenance only.
