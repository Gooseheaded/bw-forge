...
- Upstream version/tag: `v0.1.1`
- Upstream commit: `0ba6042053bfacb06d3252fac1e5435876336902`
...
generation-bearing `bw_unit_instance_id(index) -> i32` export. Release v0.1.1
also exposes the engine's existing five-slot production queue through the
